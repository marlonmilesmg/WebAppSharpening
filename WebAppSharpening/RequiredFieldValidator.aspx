<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RequiredFieldValidator.aspx.cs" Inherits="WebAppSharpening.RequiredFieldValidator" %>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorGender" runat="server" ErrorMessage="Gender is required" InitialValue="-1"
                            ForeColor="Red" ControlToValidate="ddlGender">
                        </asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
